...
const IN_PRACTICE_ITEMS = [
  ...
  // ---- ADDED BATCH 2 — remaining real photography from the repo -------------
  // Populated on request ("các hình webp có trong repo up lên hết đi") after
  // the initial 30-photo build. Excluded from this batch: exact-duplicate
  // files (TKG_16_9.webp is pixel-identical to TKG_16_9_1.webp; "IMG_8648
  // copy.webp" duplicates IMG_8648.webp already on the wall; Founders.webp /
  // Founders-mobile.webp are alternate crops of Founders-tablet.webp already
  // on the wall), pure logo/wordmark files (SAVVI.webp, Thien-Kien-logo.webp,
  // VG2_final_logo.webp), and nanaya.webp / nanaya-promo.jpg (a third-party
  // restaurant's own promotional photo, not TKG content — left out
  // deliberately; ask if you actually want it added).
  {
  ...
  },
  {
    ...
    image: "VG2_3.webp",
    category: "people",
    caption: "Setting up, before the doors open",
    location: "Ho Chi Minh City",
    partner: "Very Good Viet Goods (Thiện Kiến showcase)",
    story: "vg2-launch",
    published: true,
  ...
  },
  {
    ...
    image: "VG2_5.webp",
    category: "people",
    caption: "Thiện Kiến, on the floor",
    location: "Ho Chi Minh City",
    partner: "Very Good Viet Goods (Thiện Kiến showcase)",
    story: "vg2-launch",
    published: true,
